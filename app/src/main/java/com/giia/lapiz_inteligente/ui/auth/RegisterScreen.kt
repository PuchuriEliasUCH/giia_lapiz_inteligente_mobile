...
fun RegisterScreen(
    ...
    var lastname by remember { androidx.compose.runtime.mutableStateOf("") }
    ...
    var nameError by remember { androidx.compose.runtime.mutableStateOf<String?>(null) }
    var lastnameError by remember { androidx.compose.runtime.mutableStateOf<String?>(null) }
