...
fun ChildCreateScreen(
    ...
    var dominantHand by remember { mutableStateOf("") }
    var schoolGrade by remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                value = birthDateMillis?.let { dateFormat.format(Date(it)) } ?: "",
                onValueChange = {},
                    ...
                    when {
                        ...
                        name.length < 2 ->                         nameError = "El nombre debe tener al menos 2 caracteres"
                            ...
                            viewModel.createChild(
                                name = name.trim(),
                                birthDate = birthDateMillis?.let { dateFormat.format(Date(it)) },
